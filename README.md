...
- `[Lu et al. NIPS22]` LGDN: Language-Guided Denoising Network for Video-Language Modeling. [[paper]](https://arxiv.org/abs/2209.11388)
...
- `[Zhao et al. SIGIR22]` CenterCLIP: Token Clustering for Efficient Text-Video Retrieval. [[paper]](https://arxiv.org/abs/2205.00823)
